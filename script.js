  ...
  if (typeof translations === 'undefined') {
    window.translations = {
      id: { 
        ...
        currentLowerLabel: 'Lower Limit (saat ini:',
        currentUpperLabel: 'Upper Limit (saat ini:',
        newLowerLabel: 'Lower Limit Baru',
        newUpperLabel: 'Upper Limit Baru',
        saveButton: 'Simpan',
        resetButton: 'Reset',
        resetDataButton: 'Reset Data',
        saveMachinePartButton: 'Simpan Machine & Part',
        closeButton: 'Tutup'
      },
      en: { 
        title: 'Dashboard', 
        ...
        partNameLabel: 'PART NAME',
        partNumberLabel: 'PART NUMBER',
        currentLowerLabel: 'Lower Limit (current:',
        currentUpperLabel: 'Upper Limit (current:',
        newLowerLabel: 'New Lower Limit',
        newUpperLabel: 'New Upper Limit',
        saveButton: 'Save',
        resetButton: 'Reset',
        resetDataButton: 'Reset Data',
        saveMachinePartButton: 'Save Machine & Part',
        closeButton: 'Close'
      }
    };
  }
